...
export default class HeaderForm extends Component {
  ...
  render() {
    ...
    console.log(audios);
    return (
      <div className="ge-header-form row space-around">
        <div className="row align-start space-around">
          <div className="col margin-5">
            ...
            <div className="ge-operation row wrap">
              <a
                className="ge-github"
                rel="noopener noreferrer"
                href="https://github.com/Haixiang6123/Guitar-Editor"
                target="_blank"
              >
                <svg
                  height="28"
              ...
              <Button type="danger" onClick={tips}>
                Tips
              </Button>
              {isSaved ? (
