...
const Announcement: FC<AnnouncementProps> = ({ setIsAnnouncementOpen }) => {
  ...
  return (
    <Root>
      <div>
        ☆ If you like Open-Radio.Net, give it a star on{" "}
        <Link
          href="https://github.com/dimimikadze/Open-Radio.Net"
          target="__blank"
      ...
      <div>
        <Iframe
          src="https://ghbtns.com/github-btn.html?user=dimimikadze&repo=Open-Radio.Net&type=star&count=true"
          frameBorder="0"
          scrolling="0"
          width="104"
          height="20"
